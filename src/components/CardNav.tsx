...
const CardNav: React.FC<CardNavProps> = ({
  ...
  /* ── Animação de transição (aparecer após o Hero) ── */
  const { scrollY } = useScroll();
  // Hero is 200vh. Aparece por volta de 80vh para já dar as caras antes de HeroMain.
    ...
    >
      <nav ref={navRef} className={`card-nav ${isExpanded ? 'open' : ''}`} style={{ backgroundColor: baseColor }}>
        <div className="card-nav-top">
          ...
          <div className="logo-container" style={{ color: menuColor || '#000' }}>
